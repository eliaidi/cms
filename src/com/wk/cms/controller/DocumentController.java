...
public class DocumentController {
	...
	public ModelAndView view(@PathVariable("docId") String documentId) {
		...
		try {
			...
			document.setAppendixs(CommonUtils.list2Set(appendixService
					.findByDocId(documentId)));
	...
	public @ResponseBody
	Message detail(String docId) throws ServiceException {
	...
	@RequestMapping("/save")
	public @ResponseBody
	Message save(@Valid Document document, String channelId, String appIds,
	...
	public @ResponseBody
	Message delete(String id) throws ServiceException {
	...
	public @ResponseBody
	Message deleteByIds(String ids) throws ServiceException {
	...
	public @ResponseBody
	Message remote(String url) throws ParseException, ServiceException {
	...
	@RequestMapping("/copy")
	public @ResponseBody
	Message copy(@RequestParam("objIds") String[] objIds, String channelId)
			throws ServiceException {
	...
	@RequestMapping("/cut")
	public @ResponseBody
	Message cut(@RequestParam("objIds") String[] objIds, String channelId)
			throws ServiceException {
	...
	@RequestMapping("/move")
	public @ResponseBody
	Message move(String currId, String targetId) throws ServiceException {

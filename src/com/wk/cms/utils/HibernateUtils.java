...
public class HibernateUtils {
	...
	public static Projection getProjections(Class<Document> class1,
			ShowArea list) {
	...
	public static List<String> getShowFields(Class<Document> class1, ShowArea list) {
		...
		for(Field field : fields){
			...
			if(show==null||show.value().equals(ShowArea.ALL)||show.value().equals(list)){
